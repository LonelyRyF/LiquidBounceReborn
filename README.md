...
## Issues
If you notice any bugs or missing features, you can let us know by opening an issue [here](https://github.com/PaimonMinecraft/LiquidBounceReborn/issues).
...
1. Clone the repository using `git clone https://github.com/Nel1yMinecraft/LiquidBounceReborn/`. 
