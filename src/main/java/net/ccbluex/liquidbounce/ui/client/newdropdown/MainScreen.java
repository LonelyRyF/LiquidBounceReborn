...
import cn.liying.fonts.impl.Fonts;
...
public class MainScreen implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        cn.liying.fonts.impl.Fonts.SFBOLD.SFBOLD_26.SFBOLD_26.drawString(category.name(), x + 5, y + Fonts.SFBOLD.SFBOLD_26.SFBOLD_26.getMiddleOfBox(categoryRectHeight), textColor);
