...
class GuiTheAltening(private val prevGui: GuiAltManager) : WrappedGuiScreen() {
    ...
    override fun initGui() {
        ...
        // Token text field
        tokenField = classProvider.createGuiTextField(666, Fonts.roboto40, representedScreen.width / 2 - 100, 50, 200, 20)
        tokenField.isFocused = true
        tokenField.maxStringLength = Integer.MAX_VALUE

        // Api key password field
        apiKeyField =
            classProvider.createGuiPasswordField(1337, Fonts.roboto40, representedScreen.width / 2 - 100, 115, 200, 20)
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.roboto35.drawCenteredString("TheAltening", representedScreen.width / 2.0f, 6.0f, 0xffffff)
        Fonts.roboto35.drawCenteredString(status, representedScreen.width / 2.0f, 18.0f, 0xffffff)
        ...
        // Draw text
        Fonts.roboto40.drawCenteredString("§7Token:", representedScreen.width / 2.0f - 84, 40.0f, 0xffffff)
        Fonts.roboto40.drawCenteredString("§7API-Key:", representedScreen.width / 2.0f - 78, 105.0f, 0xffffff)
        Fonts.roboto40.drawCenteredString(
