...
@ModuleInfo(name = "HytAntiFakePlayer", description = "Made and Fixed by RyF with ❤", category = ModuleCategory.HYT)
class HytAntiFakePlayer : Module() {
    ...
    val CLIENT_NAME = LiquidBounce.CLIENT_NAME
