...
@ModuleInfo(name = "HytAntiLag", description = "Recall", category = ModuleCategory.MOVEMENT)
class HytAntiLag : Module() {

    private val modeValue = ListValue("Mode", arrayOf("Hyt","AAC5","Test"), "Hyt")
    private var ticks = 0
    private var a = 0
    private var b=0
